...
export default function Home() {
  ...
  // ১. ম্যানুয়াল প্রোডাক্ট ডাটা (Local Images)
  const products = [
  ...
  return (
    <div className="space-y-16 pb-10">
      ...
      <div className="hero min-h-[70vh] relative flex justify-center items-center">
        ...
        {/* ২. হিরো ইমেজ চেঞ্জ করা হয়েছে */}
        <Image
          src="/images/hero-bg.jpg"  // <--- আপনার লোকাল ইমেজের পাথ
          alt="Hero"
          fill
          priority
      ...
      <section className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {/* ৩. লুপ চালিয়ে ম্যানুয়াল ডাটা শো করা হচ্ছে */}
          {products.map((item) => (
            <div key={item.id} className="card bg-white shadow-md hover:scale-105 transition duration-300">
              ...
              <figure className="relative w-full h-48">
                <Image
                  src={item.image} // <--- অ্যারে থেকে ইমেজ পাথ নিচ্ছে
                  alt={item.title}
                  fill
